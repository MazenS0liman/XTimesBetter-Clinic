...
import styles from './FilterAppointmentsForDoctorByDate.module.css'
...
const AppointmentsByDateViewDoctor = () => {
    ...
    const buildFetchUrl = (chosenDate) => {
        ...
        return `http://localhost:5000/doctor/filterAppointmentsByDateForDoctor/filter?date=${encodeURIComponent(formattedDate)}`;
    };
