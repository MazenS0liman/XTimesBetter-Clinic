...
import { faUserDoctor, faUser, faUserNurse, faCircleArrowRight } from '@fortawesome/free-solid-svg-icons';
        ...
        <div className={styles['text__input__div']}>
          <form className={styles['text__form']} onSubmit={handleSendMessage}>
            ...
            <button className={styles['sendBtn']}>
              <FontAwesomeIcon icon={faCircleArrowRight} className={styles['sendBtn__icon']} />
            </button>
          </form>
        </div>
      </>
