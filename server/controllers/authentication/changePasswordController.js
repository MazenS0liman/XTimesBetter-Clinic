...
const updatePassword = asyncHandler(async (req, res) => {
    ...
    if ((patientResults.length != 0 && doctorResults.length != 0) || (patientResults.length != 0 && adminResults.length != 0) || (doctorResults.length != 0 && adminResults.length != 0)) {
